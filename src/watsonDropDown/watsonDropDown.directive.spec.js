...
describe('Directive: watsonDropDown', function() {
    ...
    it('should reflects changes to the scope', function() {
        ...
        // Compile a piece of HTML containing the directive
        var element = $compile('<watson-drop-down menu-items="dropDownData.items" title="dropDownData.title" my-class="dropDownData.myClass" action="myAction"></watson-drop-down><p>{{text}}</p>')(scope);
